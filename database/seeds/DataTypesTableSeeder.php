    ...
    public function run()
    {
        ...
        \DB::table('data_types')->insert(array (
            ...
            array (
                ...
                'created_at' => '2020-05-28 14:59:53',
                'updated_at' => '2020-06-08 16:01:36',
            ),
            6 => 
            array (
                'id' => 8,
                'name' => 'mailchimp',
                'slug' => 'mailchimp',
                'display_name_singular' => 'Mailchimp',
                'display_name_plural' => 'Mailchimps',
                'icon' => NULL,
                'model_name' => 'App\\Mailchimp',
                'policy_name' => NULL,
                'controller' => NULL,
                'description' => NULL,
                'generate_permissions' => 1,
            ...
            array (
                ...
                'name' => 'donates',
                'slug' => 'donates',
                'display_name_singular' => 'Donate',
                'display_name_plural' => 'Donates',
                'icon' => NULL,
                'model_name' => 'App\\Donate',
                'policy_name' => NULL,
                'controller' => NULL,
                'description' => NULL,
                'generate_permissions' => 1,
